...
# Model files live next to this module, not in the caller's cwd.
...
class MediaPipeFace:
    def __init__(self, static_image_mode=True, max_num_faces=1):
        ...
        base_options = mp_tasks.BaseOptions(model_asset_path=_model_path('face_landmarker.task'))
...
class MediaPipeHand:
    def __init__(self, static_image_mode=True, max_num_hands=1, intrin=None):
        ...
        base_options = mp_tasks.BaseOptions(model_asset_path=_model_path('hand_landmarker.task'))
...
class MediaPipeBody:
    def __init__(self, static_image_mode=True, model_complexity=1, intrin=None):
        ...
        base_options = mp_tasks.BaseOptions(model_asset_path=_model_path(model_file))
...
class MediaPipeHolistic:
    def __init__(self, static_image_mode=True, model_complexity=1, intrin=None):
        ...
        base_options = mp_tasks.BaseOptions(model_asset_path=_model_path('holistic_landmarker.task'))
